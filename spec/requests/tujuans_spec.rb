...
RSpec.describe '/tujuans', type: :request do
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get tujuans_url, headers: valid_headers, as: :json
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested tujuan' do
      tujuan = Tujuan.create! valid_attributes
      expect do
        delete tujuan_url(tujuan), headers: valid_headers, as: :json
      end.to change(Tujuan, :count).by(-1)
    end
  end
end
